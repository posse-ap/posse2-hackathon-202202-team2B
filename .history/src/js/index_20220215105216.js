...
let message = document.getElementById('message');
    function lastmessage(){
        ...
        aLink.innerHTML = "POSSEへようこそ!!"
        aLink.href = ("https://docs.google.com/forms/d/1wqY5_Vh4aR_9MLO0ajiNwIj0maHaoNwLJg1XIkdqQ6k/viewform?edit_requested=true")
        message.appendChild(aLink);
    }
nextQuizBtn.addEventListener('click', event => {
  event.preventDefault();
//   let  = document.getElementById('next-quiz');  
  // 次の問題へ進む
  currentQuiz++;
  ...
  // 全ての問題に回答した
    ...
    showResults('POSSE2へようこそ https://docs.google.com/forms/d/1wqY5_Vh4aR_9MLO0ajiNwIj0maHaoNwLJg1XIkdqQ6k/viewform?edit_requested=true'); 
    lastmessage();
